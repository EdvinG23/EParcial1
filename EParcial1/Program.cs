...
namespace Parcial1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                while (contador < numberStudents)
                {
                    ...
                    Student students = new Student() { Nombre = nombre, Edad = edad, Nota1 = nota1, Nota2 = nota2, Parcial1 = parcial1, Notafinal = notaFinal };
        ...
        public class Student
        {
            ...
            {
                return "Nombre: " + _nombre + " Edad: " + _edad + " Nota1: " + _nota1 + " Nota2: " + _nota2 + " Parcial1: " + _parcial1 + " NotaFinal: " + _notaFinal;
            }
